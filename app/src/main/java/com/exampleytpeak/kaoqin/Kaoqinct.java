...
public class Kaoqinct extends BaseActivity {
    ...
    public void initLayout() {
        setContentView(R.layout.activity_kaoqinct);
    }
    ...
    public void initEvent() {
        tvAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Kaoqinct.this, AddKaoqinAct.class);
    ...
    public class PlanAdapter extends RecyclerView.Adapter<PlanAdapter.MainViewHolder> {
        ...
        public PlanAdapter.MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_kaoqin, parent, false);
        ...
        public void onBindViewHolder(final MainViewHolder holder, final int position) {
            ...
            if (dataBeans.get(position).isIschuqin()) {
                holder.tv_chuqin.setText("Attended");
                holder.tv_chuqin.setTextColor(getResources().getColor(R.color.canok));
            } else {
                holder.tv_chuqin.setTextColor(getResources().getColor(R.color.mycolor_theme));
                holder.tv_chuqin.setText("Unattended");
            }
        }
        ...
        class MainViewHolder extends RecyclerView.ViewHolder {
            ...
            public MainViewHolder(View itemView) {
                ...
                tv_chuqin = itemView.findViewById(R.id.tv_chuqin);
            }
        }
    }
